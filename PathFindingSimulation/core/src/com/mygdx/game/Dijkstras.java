...
import com.mygdx.game.Connect.JunctionNode;
import com.mygdx.game.Connect.JunctionPath;
//import com.pathfinding.sim.Connect.StreetFinder;
...
//     * @param cityMap: The graph containing the nodes and paths between those nodes
...
//     */
//    public JunctionNode calculateShortestPath(CityMap cityMap, JunctionNode startNode, JunctionNode targetNode) {
...
//    } // end of printShortestPath
    ...
    public GraphPath<City> findShortestPath(City startCity, City goalCity, CityMap cityMap, CityHeuristic cityHeuristic){
        GraphPath<City> cityPath = new DefaultGraphPath<>();
        new IndexedAStarPathFinder<>(cityMap).searchNodePath(startCity, goalCity, cityHeuristic, cityPath);
        return cityPath;
    }
}
